      ...
      <div className="mx-auto w-full max-w-6xl px-6 py-12 md:py-16">
        ...
        <section className="relative overflow-hidden rounded-[32px] border border-slate-200/70 bg-white/70 shadow-[0_30px_90px_rgba(15,23,42,0.12)] backdrop-blur">
          ...
          <div className="grid gap-10 px-7 py-10 md:grid-cols-2 md:items-center md:px-12 md:py-14">
            {/* LEFT: copy */}
            <div>
              <div className="inline-flex items-center gap-2 rounded-full border border-slate-200/70 bg-white/70 px-4 py-2 text-xs font-semibold text-slate-700 shadow-sm">
              ...
              <div className="mt-7 flex flex-wrap items-center gap-3">
                ...
                <Link
                  to="/ai-course"
                  className="group inline-flex items-center justify-center gap-2 rounded-2xl bg-violet-600 px-5 py-3 text-sm font-semibold text-white shadow-sm transition hover:-translate-y-0.5 hover:bg-violet-700 hover:shadow-[0_14px_30px_rgba(124,58,237,0.22)]"
                >
                  🤖 AI 맞춤 코스 받기
                ...
                <Link
                  to="/recommend"
                  className="inline-flex items-center justify-center rounded-2xl border border-slate-200 bg-white/70 px-5 py-3 text-sm font-semibold text-slate-800 shadow-sm backdrop-blur transition hover:bg-white hover:border-slate-300"
                >
                  코스 둘러보기
                </Link>
              ...
              <div className="mt-8 grid max-w-md grid-cols-3 gap-3">
                <div className="rounded-2xl border border-slate-200/70 bg-white/70 p-4 shadow-sm">
                  <div className="text-lg font-semibold text-slate-900">3–4</div>
                  <div className="mt-1 text-xs font-medium text-slate-500">
                    코스 단계
                  </div>
                </div>
                <div className="rounded-2xl border border-slate-200/70 bg-white/70 p-4 shadow-sm">
                  <div className="text-lg font-semibold text-slate-900">1분</div>
                  <div className="mt-1 text-xs font-medium text-slate-500">
                    빠른 추천
                  </div>
                </div>
                <div className="rounded-2xl border border-slate-200/70 bg-white/70 p-4 shadow-sm">
                  <div className="text-lg font-semibold text-slate-900">Pick</div>
                  <div className="mt-1 text-xs font-medium text-slate-500">
                    저장/찜
                  </div>
                </div>
              ...
              <div className="relative overflow-hidden rounded-[28px] border border-slate-200/70 bg-white/75 shadow-[0_20px_60px_rgba(15,23,42,0.12)] backdrop-blur">
                ...
                <div className="p-5">
                  ...
                  <div className="mt-5 space-y-3">
                    {[
                      ...
                      >
                        ...
                        <div className="text-xs font-semibold text-slate-300 transition group-hover:text-slate-500">
                          →
                        </div>
                      </div>
                    ))}
                  ...
                  <div className="mt-5 flex gap-2">
                    <div className="flex-1 rounded-2xl border border-slate-200 bg-white/70 px-4 py-3 text-center text-xs font-semibold text-slate-800 transition hover:bg-white hover:border-slate-300">
                      🗺️ 동선 보기
                    </div>
                    <div className="flex-1 rounded-2xl border border-slate-200 bg-white/70 px-4 py-3 text-center text-xs font-semibold text-slate-800 transition hover:bg-white hover:border-slate-300">
                      💾 저장하기
        ...
        <section className="mt-10">
          <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-4 rounded-3xl border border-slate-200/70 bg-white/65 px-6 py-5 shadow-sm backdrop-blur">
            {[
              ...
              <div key={t} className="text-xs font-semibold text-slate-600">
                {t}
              </div>
            ))}
          </div>
        ...
        <section className="mt-14">
          <div className="relative overflow-hidden rounded-[28px] border border-slate-200/70 bg-white/65 px-7 py-10 text-center shadow-sm backdrop-blur">
            ...
            <p className="mx-auto mt-2 max-w-2xl text-sm text-slate-500">
              AI 맞춤 추천으로 빠르게 시작하거나, 코스 둘러보기에서 취향대로 찾아보세요.
            </p>
            ...
            <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
              ...
              <Link
                to="/ai-course"
                className="inline-flex items-center justify-center rounded-2xl bg-violet-600 px-5 py-3 text-sm font-semibold text-white shadow-sm transition hover:-translate-y-0.5 hover:bg-violet-700"
              >
                🤖 AI 추천 시작
              </Link>
              <Link
                to="/recommend"
                className="inline-flex items-center justify-center rounded-2xl border border-slate-200 bg-white/70 px-5 py-3 text-sm font-semibold text-slate-800 shadow-sm transition hover:bg-white hover:border-slate-300"
              >
                코스 둘러보기
              </Link>
              {/* Secondary: 랜덤 */}
              <Link
                to="/random"
                className="inline-flex items-center justify-center rounded-2xl border border-violet-200 bg-violet-50/70 px-5 py-3 text-sm font-semibold text-violet-700 shadow-sm transition hover:bg-violet-50 hover:border-violet-300"
              >
                🎲 랜덤으로 빠르게
              </Link>
            </div>
